...
export default function DeepSeekProviderPage() {
  return (
    <div>
      ...
      <h1 id="deepseek" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>DeepSeek</h1>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 24 }}>
        {['Text', 'Reasoning', 'Tools', 'Streaming'].map(c => (
      ...
      <ol style={{ fontSize: 15, color: '#a1a1aa', lineHeight: 1.8, paddingLeft: 20, marginBottom: 24 }}>
        <li>Create an account at <a href="https://platform.deepseek.com" target="_blank" rel="noopener noreferrer" style={{ color: '#3b82f6' }}>platform.deepseek.com</a></li>
