...
export default function CloudflareProviderPage() {
  return (
    <div>
      ...
      <h1 id="cloudflare" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Cloudflare Workers AI</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Run models on Cloudflare&apos;s edge network.</p>
...
Dashboard → Provider Keys → Add Key → cloudflare`}
        </pre>
      </div>
    </div>
  );
