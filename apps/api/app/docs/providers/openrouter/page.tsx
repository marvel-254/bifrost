...
export default function OpenRouterProviderPage() {
  return (
    <div>
      ...
      <h1 id="openrouter" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>OpenRouter</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Access free and premium models via OpenRouter.</p>

      <h2 id="models" style={{ fontSize: 20, fontWeight: 700, marginBottom: 12 }}>Models</h2>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['llama-3.3-70b:free', 'qwen-2.5-72b:free'].map(m => (
...
Dashboard → Provider Keys → Add Key → openrouter`}
        </pre>
      </div>
    </div>
  );
