...
export default function TogetherProviderPage() {
  return (
    <div>
      ...
      <h1 id="together" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Together AI</h1>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['meta-llama/Llama-3.3-70B-Instruct-Turbo', 'meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo', 'deepseek-ai/DeepSeek-V3', 'Qwen/Qwen2.5-72B-Instruct-Turbo'].map(m => (
      ...
      <ol style={{ fontSize: 15, color: '#a1a1aa', lineHeight: 1.8, paddingLeft: 20, marginBottom: 24 }}>
        <li>Create a free account at <a href="https://api.together.xyz" target="_blank" rel="noopener noreferrer" style={{ color: '#3b82f6' }}>api.together.xyz</a></li>
...
Dashboard → Provider Keys → Add Key → together`}
        </pre>
      </div>
