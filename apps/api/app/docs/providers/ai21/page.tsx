...
export default function AI21ProviderPage() {
  return (
    <div>
      ...
      <h1 id="ai21" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>AI21 Labs</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Jamba models via AI21 Studio API.</p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['jamba-large-1', 'jamba-mini-1'].map(m => (
  ...
  -d '{
    ...
    "messages": [{"role": "user", "content": "Hello"}]
      ...
      <ol style={{ fontSize: 14, color: '#a1a1aa', lineHeight: 1.8, paddingLeft: 20 }}>
        <li>Create an account at <Link href="https://www.ai21.com" style={{ color: '#60a5fa', textDecoration: 'none' }}>ai21.com</Link></li>
        <li>Navigate to API Keys in your account settings</li>
        <li>Generate a new API key</li>
        <li>Set the <code style={{ background: '#27272a', padding: '2px 6px', borderRadius: 3, fontSize: 13 }}>AI21_API_KEY</code> environment variable</li>
