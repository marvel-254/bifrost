...
export default function FeatherlessProviderPage() {
  return (
    <div>
      ...
      <h1 id="featherless" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Featherless AI</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Free-tier access to a wide range of models, including uncensored variants.</p>
      ...
      <p style={{ fontSize: 14, color: '#d4d4d8', marginBottom: 12, lineHeight: 1.6 }}>
        1. Create an account at <Link href="https://featherless.ai" style={{ color: '#60a5fa', textDecoration: 'underline' }}>featherless.ai</Link>.<br />
...
{`https://api.featherless.ai/v1`}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['meta-llama/Meta-Llama-3.3-70B-Instruct'].map(m => (
