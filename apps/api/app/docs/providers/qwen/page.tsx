...
export default function QwenProviderPage() {
  return (
    <div>
      ...
      <h1 id="qwen" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Alibaba / Qwen</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Qwen models via Alibaba DashScope API.</p>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 24 }}>
        {['Text', 'Tools', 'Streaming', 'Long Context'].map(c => (
  ...
  -d '{
    ...
    "messages": [{"role": "user", "content": "Hello"}]
      ...
      <ol style={{ fontSize: 14, color: '#a1a1aa', lineHeight: 1.8, paddingLeft: 20 }}>
        <li>Create an account at <Link href="https://dashscope.aliyun.com" style={{ color: '#60a5fa', textDecoration: 'none' }}>dashscope.aliyun.com</Link></li>
        <li>Navigate to API Keys in the DashScope console</li>
        <li>Generate a new API key</li>
        <li>Set the <code style={{ background: '#27272a', padding: '2px 6px', borderRadius: 3, fontSize: 13 }}>QWEN_API_KEY</code> or <code style={{ background: '#27272a', padding: '2px 6px', borderRadius: 3, fontSize: 13 }}>DASHSCOPE_API_KEY</code> environment variable</li>
