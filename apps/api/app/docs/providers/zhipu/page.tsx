...
export default function ZhipuProviderPage() {
  return (
    <div>
      ...
      <h1 id="zhipu" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Zhipu AI / GLM</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>GLM models via Zhipu AI API.</p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['glm-4-flash (free)', 'glm-4-plus'].map(m => (
  ...
  -d '{
    ...
    "messages": [{"role": "user", "content": "Hello"}]
      ...
      <ol style={{ fontSize: 14, color: '#a1a1aa', lineHeight: 1.8, paddingLeft: 20 }}>
        <li>Create an account at <Link href="https://open.bigmodel.cn" style={{ color: '#60a5fa', textDecoration: 'none' }}>open.bigmodel.cn</Link></li>
        <li>Navigate to API Keys in your console</li>
        <li>Generate a new API key</li>
        <li>Set the <code style={{ background: '#27272a', padding: '2px 6px', borderRadius: 3, fontSize: 13 }}>ZHIPU_API_KEY</code> environment variable</li>
