...
export default function MistralProviderPage() {
  return (
    <div>
      ...
      <h1 id="mistral" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Mistral</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Mistral Large, Mistral Small via Mistral API.</p>

      <h2 id="models" style={{ fontSize: 20, fontWeight: 700, marginBottom: 12 }}>Models</h2>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['mistral-large-latest', 'mistral-small-latest'].map(m => (
...
Dashboard → Provider Keys → Add Key → mistral`}
        </pre>
      </div>
    </div>
  );
