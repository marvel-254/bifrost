...
export default function CerebrasProviderPage() {
  return (
    <div>
      ...
      <h1 id="cerebras" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Cerebras</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Ultra-fast inference on wafer-scale hardware.</p>

      <h2 id="models" style={{ fontSize: 20, fontWeight: 700, marginBottom: 12 }}>Models</h2>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['llama-3.3-70b', 'llama-3.1-8b'].map(m => (
...
Dashboard → Provider Keys → Add Key → cerebras`}
        </pre>
      </div>
    </div>
  );
