...
export default function NscaleProviderPage() {
  return (
    <div>
      ...
      <h1 id="nscale" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Nscale</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Free-tier GPU inference via Nscale.</p>
      ...
      <p style={{ fontSize: 14, color: '#d4d4d8', marginBottom: 12, lineHeight: 1.6 }}>
        1. Create an account at <Link href="https://nscale.com" style={{ color: '#60a5fa', textDecoration: 'underline' }}>nscale.com</Link>.<br />
...
{`https://api.nscale.com/v1`}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['nvidia/llama-3.1-8b-instruct'].map(m => (
