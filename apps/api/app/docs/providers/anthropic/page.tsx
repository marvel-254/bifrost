...
export default function AnthropicProviderPage() {
  return (
    <div>
      ...
      <h1 id="anthropic" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Anthropic</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Claude Sonnet, Claude Opus via Anthropic API.</p>

      <h2 id="models" style={{ fontSize: 20, fontWeight: 700, marginBottom: 12 }}>Models</h2>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['claude-sonnet-4', 'claude-opus-4'].map(m => (
...
Dashboard → Provider Keys → Add Key → anthropic`}
        </pre>
      </div>
    </div>
  );
