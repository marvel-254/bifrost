...
export default function OllamaCloudProviderPage() {
  return (
    <div>
      ...
      <h1 id="ollama-cloud" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Ollama Cloud</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Native Ollama API format via ollama.com.</p>

      <h2 id="models" style={{ fontSize: 20, fontWeight: 700, marginBottom: 12 }}>Models</h2>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['gemma4:31b', 'gpt-oss:20b'].map(m => (
