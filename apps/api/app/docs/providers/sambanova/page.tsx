...
export default function SambanovaProviderPage() {
  return (
    <div>
      ...
      <h1 id="sambanova" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>SambaNova</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>High-performance inference on SambaNova hardware.</p>

      <h2 id="models" style={{ fontSize: 20, fontWeight: 700, marginBottom: 12 }}>Models</h2>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['llama-3.3-70b', 'deepseek-r1'].map(m => (
...
Dashboard → Provider Keys → Add Key → sambanova`}
        </pre>
      </div>
    </div>
  );
