...
export default function GroqProviderPage() {
  return (
    <div>
      ...
      <h1 id="groq" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Groq</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Ultra-fast inference on Llama and Mixtral models.</p>
...
Dashboard → Provider Keys → Add Key → groq`}
        </pre>
      </div>
    </div>
  );
