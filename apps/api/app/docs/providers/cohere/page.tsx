...
export default function CohereProviderPage() {
  return (
    <div>
      ...
      <h1 id="cohere" style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', marginBottom: 8 }}>Cohere</h1>
      <p style={{ fontSize: 15, color: '#a1a1aa', marginBottom: 24, lineHeight: 1.6 }}>Command R+ and Command R via Cohere API.</p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }}>
        {['command-r-plus', 'command-r'].map(m => (
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 24 }}>
        {['Text', 'Tools', 'Streaming', 'RAG'].map(c => (
  ...
  -d '{
    ...
    "messages": [{"role": "user", "content": "Hello"}]
      ...
      <ol style={{ fontSize: 14, color: '#a1a1aa', lineHeight: 1.8, paddingLeft: 20 }}>
        <li>Create an account at <Link href="https://cohere.com" style={{ color: '#60a5fa', textDecoration: 'none' }}>cohere.com</Link></li>
        <li>Navigate to API Keys in your dashboard</li>
        <li>Generate a new API key</li>
        <li>Set the <code style={{ background: '#27272a', padding: '2px 6px', borderRadius: 3, fontSize: 13 }}>COHERE_API_KEY</code> environment variable</li>
